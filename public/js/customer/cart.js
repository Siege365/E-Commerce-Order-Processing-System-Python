...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const clearCartModalClose = document.getElementById('clear-cart-modal-close');
    ...
    const clearCartBackdrop = clearCartModal?.querySelector('.modal-backdrop');
    ...
    if (clearCartModalClose) {
        clearCartModalClose.addEventListener('click', () => clearCartModal.classList.remove('show'));
    }

    if (clearCartCancel) {
        clearCartCancel.addEventListener('click', () => clearCartModal.classList.remove('show'));
    }

    if (clearCartBackdrop) {
        clearCartBackdrop.addEventListener('click', () => clearCartModal.classList.remove('show'));
    }

    if (clearCartConfirm) {
        clearCartConfirm.addEventListener('click', clearCart);
    }
